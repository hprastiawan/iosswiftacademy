...
class MainTabBarController: UITabBarController, UITabBarControllerDelegate {
  ...
  let homeViewController = UINavigationController(rootViewController: DashboardViewController())
  let searchViewController = UINavigationController(rootViewController: SecondViewController())
  let midlleViewController = UINavigationController(rootViewController: UIViewController())
  let favoriteViewController = UINavigationController(rootViewController: DashboardGridViewController())
